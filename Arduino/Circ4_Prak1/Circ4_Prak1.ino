...
void loop()
{
  ...
  //fromCenter(); //Turn on LED from center to the edges
}
...
void fromCenter()
{
  ...
  delay(delayTime);                //wait delayTime milliseconds
  digitalWrite(ledPins[0], HIGH);  //Turns on LED #3 (pin 5)
  ...
  delay(delayTime);                //wait delayTime milliseconds
  digitalWrite(ledPins[1], LOW);  //Turns on LED #2 (pin 4)
  digitalWrite(ledPins[6], LOW);
  delay(delayTime);                //wait delayTime milliseconds
  digitalWrite(ledPins[0], LOW);  //Turns on LED #3 (pin 5)
